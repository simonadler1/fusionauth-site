...
<APIBlock>
  <APIField name="Enabled" type="UUID" required>
    Description!
    [A link to something](/docs/something)
  </APIField>
  <APIField name="preventingLogin" type="Boolean" optional since="1.4.0" defaults="False">
    Description!
    [A link to something](/docs/something)
  </APIField>
</APIBlock>
...
If you require a different hashing scheme, you can build a [password hashing plugin](/docs/v1/tech/plugins/custom-password-hashing).
