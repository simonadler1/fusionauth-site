...
You might do this if you are using the [Login API](/docs/v1/tech/apis/login) rather than using the hosted FusionAuth login pages.

Completing the login is [documented further in the API](/docs/v1/tech/apis/identity-providers/{identity_provider_path}#complete-the-{identity_provider_fragment}-login).
