...
<img src="/img/docs/authenticate/add-login/social/login-hypr.png" alt="OpenID Connect Login" width="1200" role="shadowed" />
...
<img src="/img/docs/authenticate/add-login/social/identity-provider-hypr-add.png" alt="Add HYPR" width="1200" />
