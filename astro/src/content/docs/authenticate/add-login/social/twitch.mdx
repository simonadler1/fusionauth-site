...
<img src="/img/docs/authenticate/add-login/social/login-twitch.png" alt="Login Twitch" width="1200" />
...
<img src="/img/docs/authenticate/add-login/social/twitch-create-app.png" alt="Create Twitch App" width="1200" role="shadowed" />
...
<img src="/img/docs/authenticate/add-login/social/identity-provider-twitch-add.png" alt="Twitch Home" width="1200" />

<IdpFormFields get_started_link="link:https://dev.twitch.tv/[Twitch - Getting Started]" identity_provider="Twitch" linking_strategy="Create a pending link" scope_default="openid user:read:email" scope_description="The optional scope parameter used by Twitch to request details about the user." />

## Building Your Own Integration

<LoginApiIntegration identity_provider_fragment="twitch" identity_provider_path="twitch" />
