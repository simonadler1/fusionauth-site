...
<img src="/img/docs/authenticate/add-login/social/login-twitter.png" alt="Twitter Login" width="1200"  role="bottom-cropped" />
...
<img src="/img/docs/authenticate/add-login/social/twitter-home-create.png" alt="Twitter Create App" width="1200" />
...
<img src="/img/docs/authenticate/add-login/social/twitter-auth-settings.png" alt="Authentication Settings" width="1200" />

#### Add a Callback URI <span style="height: 50%; width: 50%;"> <span class="fa-stack fa-2x" style="color: #F4821F;"> <i class="fa fa-circle fa-stack-1x"></i> <span class="fa-stack-1x calendar-text" style="color: white; font-family: sans-serif; font-size: medium">1</span> </span> </span>
...
<img src="/img/docs/authenticate/add-login/social/twitter-keys-tokens.png" alt="Twitter Keys and tokens" width="1200"  role="bottom-cropped" />
...
<img src="/img/docs/authenticate/add-login/social/twitter-add-provider.png" alt="Add provider" width="1200"  role="bottom-cropped" />
...
<img src="/img/docs/authenticate/add-login/social/identity-provider-twitter-add.png" alt="Add Twitter" width="1200" role="shadowed" />
...
<LoginApiIntegration identity_provider_fragment="twitter" identity_provider_path="twitter" />
