...
<img src="/img/docs/authenticate/add-login/social/login-linkedin.png" alt="LinkedIn Login" width="1200" role="bottom-cropped" />
...
<img src="/img/docs/authenticate/add-login/social/linkedin-create-app.png" alt="Create LinkedIn App" width="1200" />
...
<img src="/img/docs/authenticate/add-login/social/linkedin-adding-product.png" alt="Adding the Sign In With LinkedIn product" width="1200" />
...
<img src="/img/docs/authenticate/add-login/social/linkedin-app-credentials.png" alt="Retrieve LinkedIn Credentials" width="1200" />
...
<img src="/img/docs/authenticate/add-login/social/identity-provider-linkedin-add.png" alt="Add the LinkedIn Identity Provider" width="1200" />
...
<LoginApiIntegration identity_provider_fragment="linkedin" identity_provider_path="linkedin" />
