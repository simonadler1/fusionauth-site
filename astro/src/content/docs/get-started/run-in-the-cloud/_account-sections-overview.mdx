...
* <strong>Deployments</strong> - configure and manage FusionAuth Cloud deployments.
...
* <strong>Support</strong> - learn more about support options or open a support ticket. [Learn more about technical support](/docs/v1/tech/admin-guide/technical-support).
...
<img src="/img/docs/get-started/run-in-the-cloud/home-tab.png" alt="The dashboard of the FusionAuth Cloud account application." width="1200" role="bottom-cropped" />
