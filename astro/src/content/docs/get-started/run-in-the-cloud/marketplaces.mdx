...
Once you install FusionAuth using the marketplace, you can [add a license](/docs/v1/tech/admin-guide/licensing). Doing so will allow you to use [additional features](/docs/v1/tech/core-concepts/editions-features).
