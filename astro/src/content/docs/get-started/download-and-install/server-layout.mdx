...
[Install a Database](/docs/v1/tech/installation-guide/database)

[Install FusionAuth Search](/docs/v1/tech/installation-guide/fusionauth-search)

[Install FusionAuth App](/docs/v1/tech/installation-guide/fusionauth-app)

### Single server

<img src="/img/docs/getting-started/download-and-install/single-server.png" alt="One Server" width="285"/>
...
<img alt="Two servers with an external database" src="/img/docs/getting-started/download-and-install/two-servers-external-db.png" width="875"/>
...
<img alt="Horizontally scaled with an external database" src="/img/docs/getting-started/download-and-install/n-servers-external-db.png" width="600"/>
