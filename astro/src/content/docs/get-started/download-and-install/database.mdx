...
In order to use FusionAuth, you need to install a database. The database requirements are provided in the [System Requirements](/docs/v1/tech/installation-guide/system-requirements).
...
options, if startup still fails due to this validation you may disable this feature. See `database.mysql.enforce-utf8mb4` in the [Configuration](/docs/v1/tech/reference/configuration) reference.
