...
`fusionauth.properties` configuration file. More information about this configuration file is located in the [Configuration Reference](/docs/v1/tech/reference/configuration) section.
...
[Configuration Reference](/docs/v1/tech/reference/configuration) for more information on configuring the `fusionauth-search.hosts` property.
