...
<img src="/img/docs/get-started/download-and-install/k8s/aks.png" alt="EKS Architecture" width="1200" />
...
For more information on the [create](https://docs.microsoft.com/en-us/cli/azure/aks?view=azure-cli-latest#az_aks_create) command, se[az aks crea](e https://docs.microsoft.com/en-us/cli/azure/aks?view=azure-cli-latest#az_aks_create)e] documentation.
...
<img src="/img/docs/get-started/download-and-install/k8s/az-es-start.png" alt="Navigate to Elasticsearch service" width="1200" role="top-cropped bottom-cropped" />

Click on the **Create Elasticsearch (Elastic Cloud)** button.

<img src="/img/docs/get-started/download-and-install/k8s/az-es-create.png" alt="Create Elasticsearch" width="1200" role="top-cropped bottom-cropped" />
...
<img src="/img/docs/get-started/download-and-install/k8s/az-es-create-resource.png" alt="Create resource screen" width="1200" role="top-cropped bottom-cropped" />

Review your selections and press the **Create** button when ready.

<img src="/img/docs/get-started/download-and-install/k8s/az-es-review-create.png" alt="Review and create screen" width="1200" role="top-cropped bottom-cropped" />

Your deployment will now be in-progress as indicated on the next screen. This may take a few minutes to complete.

<img src="/img/docs/get-started/download-and-install/k8s/az-es-in-progress.png" alt="In-progress screen" width="1200" role="top-cropped bottom-cropped" />
...
<img src="/img/docs/get-started/download-and-install/k8s/az-es-resource-group.png" alt="Resources screen" width="1200" role="top-cropped bottom-cropped" />

Click on the **Manage changes in Elastic Cloud** link.

<img src="/img/docs/get-started/download-and-install/k8s/az-es-example.png" alt="Elasticsearch resource detail screen" width="1200" role="top-cropped bottom-cropped" />
...
<img src="/img/docs/get-started/download-and-install/k8s/az-es-copy-endpoint.png" alt="Example dashboard on Elastic Cloud" width="1200" role="top-cropped bottom-cropped" />

Click on the **Reset Password** button to set your administrative credentials for your cluster.

<img src="/img/docs/get-started/download-and-install/k8s/az-es-security.png" alt="Security screen" width="1200" role="top-cropped bottom-cropped" />
