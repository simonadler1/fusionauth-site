...
import Kubectl from 'src/content/docs/get-started/download-and-install/k8s/_kubectl.mdx';
...
<img src="/img/docs/get-started/download-and-install/k8s/gke-architecture.png" alt="GKE Architecture" width="1200" />
...
For more information on the [create](https://cloud.google.com/sdk/gcloud/reference/container/clusters/create) command, se[gcloud container clusters crea](e https://cloud.google.com/sdk/gcloud/reference/container/clusters/create)e] documentation.
...
* `database-version` - Database engine type and version. See FusionAuth supported databases [here](/docs/v1/tech/installation-guide/system-requirements#database).
...
For more information on the [create](https://cloud.google.com/sdk/gcloud/reference/beta/sql/instances/create) command, se[gcloud beta sql instances crea](e https://cloud.google.com/sdk/gcloud/reference/beta/sql/instances/create)e] documentation.
...
<img src="/img/docs/get-started/download-and-install/k8s/es-enable.png" alt="Elasticsearch service enable subscription screen" width="1200" role="top-cropped bottom-cropped" />
...
<img src="/img/docs/get-started/download-and-install/k8s/es-manage-via.png" alt="GCP Elasticsearch service screen" width="1200" role="top-cropped bottom-cropped" />

This will redirect you to the [Elastic Cloud](https://cloud.elastic.co/home) website. Login t[Elastic Clo](o https://cloud.elastic.co/home)d] using your Google account credentials.
...
<img src="/img/docs/get-started/download-and-install/k8s/es-cloud-dashboard.png" alt="Elastic Cloud dashboard screen" width="1200" role="top-cropped bottom-cropped" />

Input a name for your deployment and again click on `Create deployment`.

<img src="/img/docs/get-started/download-and-install/k8s/es-create-deployment.png" alt="Create deployment screen" width="1200" role="top-cropped bottom-cropped" />
...
<img src="/img/docs/get-started/download-and-install/k8s/es-save-credentials.png" alt="Save credentials screen" width="1200" role="top-cropped bottom-cropped" />
...
<img src="/img/docs/get-started/download-and-install/k8s/es-cloud-dashboard-2.png" alt="Elastic Cloud dashboard with deployment screen" width="1200" role="top-cropped bottom-cropped" />
...
<img src="/img/docs/get-started/download-and-install/k8s/es-dashboard.png" alt="Elastic Cloud deployment dashboard screen" width="1200" role="top-cropped bottom-cropped" />

Under **Applications**, click on the `Copy endpoint` link next to **Elasticsearch** to copy the URL to your clipboard. You will need to save this URL for use when [deploying FusionAuth](/docs/v1/tech/installation-guide/kubernetes/fusionauth-deployment) to your GKE cluster.

## Next Steps

You now are running all the necessary infrastructure to deploy a containerized application to GKE.

Next up, [Deploy FusionAuth in Kubernetes](/docs/v1/tech/installation-guide/kubernetes/fusionauth-deployment).
