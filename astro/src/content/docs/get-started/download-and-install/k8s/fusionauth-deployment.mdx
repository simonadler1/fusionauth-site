...
Since the Kubernetes container runtime supports [Docker](/docs/v1/tech/installation-guide/docker), FusionAuth [Docker](/docs/v1/tech/installation-guide/docker) containers can be deployed to any Kubernetes cluster.

The following guide demonstrates how to deploy FusionAuth containers using [kubectl](https://kubernetes.io/docs/tasks/tools/), the Kubernetes command-line tool that enables you to send commands to a cluster through th[API serv](e https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/)r].
...
+
** [Local setup using minikube](/docs/v1/tech/installation-guide/kubernetes/setup/minikube)
** [Amazon Elastic Kubernetes Service (EKS)](/docs/v1/tech/installation-guide/kubernetes/setup/eks)
** [Google Kubernetes Engine (GKE)](/docs/v1/tech/installation-guide/kubernetes/setup/gke)
** [Microsoft Azure Kubernetes Service (AKS)](/docs/v1/tech/installation-guide/kubernetes/setup/aks)
...
The [field]#replicaCount# value indicates the number of instances of FusionAuth to run in a [ReplicaSet](https://kubernetes.io/docs/concepts/workloads/controllers/replicaset/).
...
If you don't want to provide the `database.root.user` and `database.root.password` to allow FusionAuth to set up the database itself, you can also follow the [advanced database installation guide](/docs/v1/tech/installation-guide/fusionauth-app#advanced-installation) which lets you set up the database out of band.
...
<img src="/img/docs/get-started/download-and-install/k8s/fa-initial-config.png" alt="FusionAuth bootstrap" width="1200" role="bottom-cropped" />
