...
Next, install the FusionAuth services, you can optionally skip the `fusionauth-search` service if you would like to use the database as the User search engine, or if you already have a compatible Elasticsearch service running. See the [System Requirements](/docs/v1/tech/installation-guide/system-requirements) and [Configuration Reference](/docs/v1/tech/reference/configuration).
