...
[field]#systemConfiguration.webhookEventLogConfiguration.numberOfDaysToRetain# [type]#[Integer]# [optional]#Optional# [default]#defaults to `30`# [since]#Available since 1.38.1#::
The number of days to retain webhook event log records.
