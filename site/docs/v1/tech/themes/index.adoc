...
[field]#OAuth start IdP link# [required]#Required#::
This page is used when linking a IdP user to FusionAuth. This page is used when "Creat a pending link" is selected as a linking strategy.  link:/docs/v1/tech/identity-providers/#linking-strategies[See Linking Strategies]
+
