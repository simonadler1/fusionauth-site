...
After your deployment has been provisioned, you will want to access the FusionAuth UI (described below) and activate Reactor to enable any paid edition features.  Additional information about doing this can be found link:https://fusionauth.io/docs/v1/tech/reactor/#activate-reactor[here].
